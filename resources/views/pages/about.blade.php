	...
	<div class="container">
		...
		<div class="row fadeIn animated">
			...
			<div class="col-md-6">
				...
				<img src="{{URL::asset('assets/images/about-us.jpg')}}" alt="" class="img-responsive">
    				...
    				<div class="col-md-3 col-sm-6">
    					...
    					<div class="team-member">
    						...
    						<div class="thumnail">
    							...
    							<img src="{{URL::asset('assets/images/team/member-1.jpg')}}" alt="" class="cause-img">
    				...
    				<div class="col-md-3 col-sm-6">
    					...
    					<div class="team-member">
    						...
    						<div class="thumnail">
    							...
    							<img src="{{URL::asset('assets/images/team/member-3.jpg')}}" alt="" class="cause-img">
    				...
    				<div class="col-md-3 col-sm-6">
    					...
    					<div class="team-member">
    						...
    						<div class="thumnail">
    							...
    							<img src="{{URL::asset('assets/images/team/member-4.jpg')}}" alt="" class="cause-img">
    				...
    				<div class="col-md-3 col-sm-6">
    					...
    					<div class="team-member">
    						...
    						<div class="thumnail">
    							...
    							<img src="{{URL::asset('assets/images/team/member-2.jpg')}}" alt="" class="cause-img">
